...
main() async {
  ...
  when(mockTaskProvider.partnerships).thenAnswer(
      (_) => [Partnership('test 1', '1'), Partnership('test 2', '2')]);
  ...
  when(mockTaskProvider.fetchPartnershipStream('1')).thenAnswer((_) {
    final mockData = {
      'id': '1',
      'name': 'test 1',
      'users': [],
  ...
  when(mockTaskProvider.fetchPartnershipStream('2')).thenAnswer((_) {
    final mockData = {
      'id': '2',
      'name': 'test 2',
      'users': [],
  ...
  testWidgets("Ensure PartnershipsListPage has all necessary sections",
      (tester) async {
    await tester.pumpWidget(MaterialApp(
      home: ChangeNotifierProvider<TaskProvider>.value(
          value: mockTaskProvider, child: PartnershipsListPage()),
    ));
  ...
  testWidgets("Ensure selecting other partnership works properly",
      (tester) async {
    await tester.pumpWidget(MaterialApp(
      home: ChangeNotifierProvider<TaskProvider>.value(
          value: mockTaskProvider, child: PartnershipsListPage()),
